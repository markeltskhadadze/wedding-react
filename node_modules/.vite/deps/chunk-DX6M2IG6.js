...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React65 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState35 = React65.useState, useEffect41 = React65.useEffect, useLayoutEffect6 = React65.useLayoutEffect, useDebugValue = React65.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime11.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React30.Children.map(children, (child) => (0, import_jsx_runtime11.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime11.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var AlertDialog = (props) => {
  ...
  return (0, import_jsx_runtime12.jsx)(Root6, { ...dialogScope, ...alertDialogProps, modal: true });
};
AlertDialog.displayName = ROOT_NAME;
var TRIGGER_NAME4 = "AlertDialogTrigger";
var AlertDialogTrigger = React31.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, ...triggerProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime12.jsx)(Trigger3, { ...dialogScope, ...triggerProps, ref: forwardedRef });
  }
);
...
var AlertDialogPortal = (props) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime12.jsx)(Portal2, { ...dialogScope, ...portalProps });
};
AlertDialogPortal.displayName = PORTAL_NAME3;
var OVERLAY_NAME2 = "AlertDialogOverlay";
var AlertDialogOverlay = React31.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, ...overlayProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime12.jsx)(Overlay, { ...dialogScope, ...overlayProps, ref: forwardedRef });
  }
);
...
var AlertDialogContent = React31.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, children, ...contentProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    const contentRef = React31.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const cancelRef = React31.useRef(null);
    return (0, import_jsx_runtime12.jsx)(
      WarningProvider,
      {
        ...
        children: (0, import_jsx_runtime12.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: (0, import_jsx_runtime12.jsxs)(
          Content3,
          {
            role: "alertdialog",
            ...dialogScope,
            ...
            children: [
              (0, import_jsx_runtime12.jsx)(Slottable, { children }),
              (0, import_jsx_runtime12.jsx)(DescriptionWarning2, { contentRef })
            ]
          }
        ) })
      }
...
var AlertDialogTitle = React31.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, ...titleProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime12.jsx)(Title, { ...dialogScope, ...titleProps, ref: forwardedRef });
  }
);
AlertDialogTitle.displayName = TITLE_NAME2;
var DESCRIPTION_NAME2 = "AlertDialogDescription";
var AlertDialogDescription = React31.forwardRef((props, forwardedRef) => {
  const { __scopeAlertDialog, ...descriptionProps } = props;
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime12.jsx)(Description, { ...dialogScope, ...descriptionProps, ref: forwardedRef });
});
AlertDialogDescription.displayName = DESCRIPTION_NAME2;
var ACTION_NAME = "AlertDialogAction";
var AlertDialogAction = React31.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, ...actionProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime12.jsx)(Close, { ...dialogScope, ...actionProps, ref: forwardedRef });
  }
);
AlertDialogAction.displayName = ACTION_NAME;
var CANCEL_NAME = "AlertDialogCancel";
var AlertDialogCancel = React31.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, ...cancelProps } = props;
    const { cancelRef } = useAlertDialogContentContext(CANCEL_NAME, __scopeAlertDialog);
    const dialogScope = useDialogScope(__scopeAlertDialog);
    const ref = useComposedRefs(forwardedRef, cancelRef);
    return (0, import_jsx_runtime12.jsx)(Close, { ...dialogScope, ...cancelProps, ref });
  }
);
...
var AspectRatio = React32.forwardRef(
  (props, forwardedRef) => {
...
var Avatar = React33.forwardRef(
  (props, forwardedRef) => {
    ...
    const [imageLoadingStatus, setImageLoadingStatus] = React33.useState("idle");
...
var AvatarImage = React33.forwardRef(
  (props, forwardedRef) => {
...
var AvatarFallback = React33.forwardRef(
  (props, forwardedRef) => {
    ...
    const [canRender, setCanRender] = React33.useState(delayMs === void 0);
    React33.useEffect(() => {
      if (delayMs !== void 0) {
...
function useImageLoadingStatus(src, { referrerPolicy, crossOrigin }) {
  ...
  const imageRef = React33.useRef(null);
  const image = (() => {
  ...
  const [loadingStatus, setLoadingStatus] = React33.useState(
...
function CheckboxProvider(props) {
  ...
  const [control, setControl] = React36.useState(null);
  const [bubbleInput, setBubbleInput] = React36.useState(null);
...
var CheckboxTrigger = React36.forwardRef(
  ({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) => {
    ...
    const initialCheckedStateRef = React36.useRef(checked);
    React36.useEffect(() => {
...
var CheckboxIndicator = React36.forwardRef(
  (props, forwardedRef) => {
...
var CheckboxBubbleInput = React36.forwardRef(
  ({ __scopeCheckbox, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React36.useRef(isIndeterminate(checked) ? false : checked);
    return (0, import_jsx_runtime15.jsx)(
      Primitive.input,
      {
        type: "checkbox",
...
export {
  ...
  dist_exports41 as dist_exports35
};
...
use-sync-external-store/cjs/use-sync-external-store-shim.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DX6M2IG6.js.map
